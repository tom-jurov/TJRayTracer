...
void TJRayTracer::TF::operator=(
    const TJRayTracer::MatrixXd<double, 4, 4> &other) {
  _transform = other;
}
...
TJRayTracer::MatrixXd<double, 4, 4> TJRayTracer::TF::scaling(double x, double y,
                                                             double z) {
  TJRayTracer::MatrixXd<double, 4, 4> result;
  result.identity();
  result(0, 0) = x;
...
TJRayTracer::MatrixXd<double, 4, 4>
TJRayTracer::TF::view_transform(const TJRayTracer::Point &from,
                                const TJRayTracer::Point &to,
