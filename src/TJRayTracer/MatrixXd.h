...
template <class T, unsigned int ROWS, unsigned int COLS> class MatrixXd {
public:
  MatrixXd();
...
template <class U, unsigned int U_ROWS, unsigned int U_COLS>
TJRayTracer::MatrixXd<U, U_ROWS, U_COLS>
TJRayTracer::MatrixXd<T, ROWS, COLS>::submatrix(unsigned int row,
                                                unsigned int col) {
